        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
          <div className="p-8 sm:p-12 md:p-16 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              >
                Our advanced analytics dashboard will help you identify strengths, weaknesses, and optimize your study plan.
              </motion.p>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-8">
            <div className="max-w-5xl mx-auto">
              <h3 className="text-lg font-medium text-center mb-6">Key Features:</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Identify topics needing more focus"
                  },
                  {
                    icon: (
                    ...
                    description: "Get customized study suggestions"
                  }
                ].map((feature, index) => (
                  <motion.div
                    key={index}
...
export default ProgressComingSoon;
